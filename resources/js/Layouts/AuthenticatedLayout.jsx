...
import SidebarAdministratorLeftssss
                                    from "@/Layouts/Partials/Administrator/SidebarAdministratorLeftssss.jsx";
...
export default function Authenticated({ user, children }) {
    ...
    return (
        ...
        <div className="antialiased bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex flex-wrap justify-between items-center">
                    ...
                    <div className="flex items-center lg:order-2">
                      ...
                      >
                        ...
                        <Dropdown
                            inline
                            label={<Avatar size="sm" bordered alt="User settings" img="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/michael-gough.png" rounded/>}
                        >
                            <Dropdown.Header>
            ...
            <aside
                className="hidden lg:block fixed right-0 top-0 bottom-0 z-30 w-16 h-full bg-white border-l border-gray-200 dark:bg-gray-800 dark:border-gray-700 pt-14">
                            ...
                            <a href="#" data-tooltip-target="tooltip-stats" data-tooltip-placement="left"
                               className="flex items-center p-2 text-gray-500 rounded-lg transition duration-75 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path clipRule="evenodd" fillRule="evenodd"
                                          d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11 4a1 1 0 10-2 0v4a1 1 0 102 0V7zm-3 1a1 1 0 10-2 0v3a1 1 0 102 0V8zM8 9a1 1 0 00-2 0v2a1 1 0 102 0V9z"></path>
                                </svg>
                                <span className="sr-only"></span>
                            </a>
                            ...
                            <a href="#" data-tooltip-target="tooltip-location" data-tooltip-placement="left"
                               className="flex items-center p-2 text-gray-500 rounded-lg transition duration-75 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                     xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path clipRule="evenodd" fillRule="evenodd"
                                          d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"></path>
                                </svg>
                                <span className="sr-only"></span>
                            </a>
