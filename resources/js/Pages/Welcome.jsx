                ...
                <header className="sticky top-0 z-30 bg-gray-900">
                    <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                        <div className="flex lg:flex-1">
                            <ApplicationLogo className="w-20 h-8 object-fill text-gray-500" />
                        </div>
                            ...
                            {auth.user ? (
                                <>
                                    <Link
                                        ...
                                        className="font-semibold text-white hover:text-yellow-400 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                                    >
                                        Dashboard
                                    </Link>
                                </>
                        ...
                        <div className="flow-root bg-gray-900 py-16 sm:pt-32 lg:pb-0">
                            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                <div className="relative z-10">
                                    ...
                                    <h2 className="mx-auto text-center mt-4 text-4xl text-white">The Powers Company</h2>
